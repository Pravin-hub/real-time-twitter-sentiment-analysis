...
with st.sidebar:
    ...
    st.markdown("[Github link](https://github.com/mayankgoyal1338/real-time-twitter-sentiment-analysis)")
    st.markdown("Created by Mayank Goyal, Aditya Kasar, Brajendra Pathak, Pravin Kumar")
